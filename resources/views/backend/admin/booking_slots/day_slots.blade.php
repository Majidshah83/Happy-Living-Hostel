    ...
    <form method="POST" id="add-slot-process-form">
      ...
      <input type="hidden" id="day_number" name="day_number" value="{{ $day_number }}" readonly="readonly" />
                        ...
                        foreach($week_day_slots as $day_slot){
                          ...
                          <tr>
                              ...
                              <td>
                                ...
                                <input type="number" step="1" min="1" max="10" class="form-control change-allowed-bookings" data-item-id="{{ $day_slot['id'] }}" id="allowed_bookings" name="allowed_bookings" value="{{ $day_slot['allowed_bookings'] }}" />

                            </td>

                              <td>
                                  
                                  <select class="form-control {{ $status_class }} change-slot-status" data-item-id="{{ $day_slot['id'] }}">
    ...
    $(document).ready(function() {
        ...
        $('.remove-slot').click(function(){ 
            ...
            $.ajax({
                ...
                url:"{{ url('booking_slots/remove_slots') }}",
        ...
        $('#add-slot-process-btn').click(function () {
            ...
            $.ajax({
                ...
                url: "{{ url('/booking_slots/add_slots_process') }}",
        ...
        $('.change-slot-status').change(function () {
            ...
            $.ajax({
                ...
                url:"{{ url('booking_slots/change_slot_status') }}",
        ...
        $('.change-allowed-bookings').change(function () {
            ...
            $.ajax({
                ...
                url:"{{ url('booking_slots/allowed_quantity') }}",
