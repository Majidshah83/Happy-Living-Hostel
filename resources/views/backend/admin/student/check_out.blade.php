    ...
    <div class="container">
        ...
        <div class="page-header">
            <div class="page-leftheader">
                <h4 class="page-title">Check Out Customer</h4>
            </div>
                                ...
                                @foreach($students as $student)
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <button type="button" title="edit" class="btn btn-danger btn-sm checkout-student" data-hash-id="{{ $student->hash_id }}">CheckIn</button>
                ...
                $.ajax({
                    ...
                    success: function(response) {
                        ...
                        if(hash_id == ''){
                            ...
                            popup_title = 'Add New Student';

                        } else {

                            popup_title = 'Edit Student';
