    ...
    <div class="container">
        ...
        <div class="page-header">
            ...
            <div class="page-rightheader ml-auto d-lg-flex d-none">
                <a href="javascript:;" class="btn btn-primary add-edit-faq" data-hash-id=""><i class="fa fa-plus mr-2"></i> Add FAQ</a>
            </div>
        </div>
        <!--Row-->
            ...
            <div class="col-xl-12 col-lg-12 col-md-12">
                <div class="card">
                    <div class="card-header">
                        <h3 class="card-title">List Faqs</h3>
                    ...
                    <div class="card-body">
                        <div class="table-responsive">
                            <table id="faq-datatable" class="table table-striped table-bordered text-nowrap" style="width:100%">
                                <thead>
                                    <tr class="bold">
                                        <th class="border-bottom-0">Faq</th>
                                ...
                                <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                @include('backend.admin.components.display_order', ['item_details' => !empty($faq) ? $faq : '' , 'resource' => 'faqs' ])

                                            </td>
                                            <td>

                                                @include('backend.admin.components.status', ['item_details' => !empty($faq) ? $faq : '' , 'resource' => 'faqs' ])

                                            </td>
                                            <td>
                                                <button type="button" title="edit" class="btn btn-success btn-sm add-edit-faq" data-hash-id="{{ $faq->hash_id }}"><i class="fa fa-edit"></i></button>

                                                <button type="button" title="edit" class="btn btn-danger btn-sm delete-faq" data-hash-id="{{ $faq->hash_id }}"><i class="fa fa-times"></i></button>
                                            </td>
                                        </tr>
                                    @endforeach
                                </tbody>
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function(){
            ...
            $('.add-edit-faq').click(function(){
                ...
                var request_url = (hash_id != '') ? 'faqs/'+hash_id+'/edit' : 'faqs/create' ;
